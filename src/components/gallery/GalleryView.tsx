      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 dark:bg-gray-950">
        ...
        >
          ...
          <input
            ...
            className={`mt-5 w-full rounded-lg border-2 bg-transparent px-3 py-2.5 text-center text-lg tracking-widest outline-none ${
              loginError ? 'border-red-400' : 'border-slate-200 focus:border-sky-500 dark:border-white/10'
            }`}
            placeholder="••••••••••"
          />
