...
const SERVICE_SEO_CONFIG: Record<string, ServiceSeoConfig> = {
  ...
  'proposal-photography': {
    keywords: {
      es: 'fotografo propuesta matrimonio santo domingo, propuesta sorpresa restaurante republica dominicana, fotografo oculto propuesta punta cana, fotografia propuesta modo ninja RD, fotografo pedida de mano secreto',
      en: 'proposal photographer santo domingo, surprise proposal restaurant dominican republic, hidden proposal photographer punta cana, ninja mode proposal photography DR, secret engagement photographer dominican republic',
    },
    serviceType: {
      es: 'Fotografia de propuesta sorpresa en modo oculto',
      en: 'Hidden mode surprise proposal photography',
    },
    focusLocations: ['Santo Domingo', 'Punta Cana', 'Cap Cana', 'La Romana', 'Samana'],
  },
}
...
const SERVICE_CONVERSION_CONFIG: Record<string, ServiceConversionConfig> = {
  ...
  'proposal-photography': {
    primaryCta: { label: { es: 'Coordinar Propuesta Secreta', en: 'Coordinate Secret Proposal' }, href: '/get-quote' },
    secondaryCta: { label: { es: 'Ver Todos los Paquetes de Propuesta', en: 'See All Proposal Packages' }, href: '/proposal' },
    leadMagnet: {
      title: { es: 'Mejores Restaurantes para Propuesta en Santo Domingo y Punta Cana', en: 'Best Proposal Restaurants in Santo Domingo and Punta Cana' },
      value: { es: 'Recomendaciones con notas de posicionamiento y luz para cada locación.', en: 'Recommendations with positioning and lighting notes per location.' },
    },
  },
}
...
const SERVICE_OFFER_CATALOG: Record<string, ServicePackageOffer[]> = {
  ...
  'proposal-photography': [
    { name: { es: 'Modo ninja en playa', en: 'Beach ninja mode' }, description: { es: 'Teleobjetivo desde la arena -- resorts, playas privadas y marinas.', en: 'Telephoto from the sand -- resorts, private beaches, and marinas.' } },
    { name: { es: 'Propuesta en restaurante', en: 'Restaurant proposal' }, description: { es: 'Coordinacion con venue, posicion interior, galeria overnight.', en: 'Venue coordination, indoor positioning, overnight gallery.' } },
    { name: { es: 'Propuesta en villa privada', en: 'Private villa proposal' }, description: { es: 'Casa de Campo, Cap Cana, Playa Nueva Romana -- acceso exclusivo.', en: 'Casa de Campo, Cap Cana, Playa Nueva Romana -- exclusive access.' } },
  ],
}
...
const SERVICE_SCHEMA_ADDITIONAL_TYPE: Record<string, string> = {
  ...
  'proposal-photography': 'https://schema.org/Service',
}
