...
- full_name: string
- service_type: one of WEDDINGS, ENGAGEMENT_SESSION, QUINCEANERAS, MATERNITY, FAMILY, BIRTHDAY_PARTY, BAPTISMS, GRADUATION, CHILDRENS_SESSIONS, ARCHITECTURE, PORTRAITS, CORPORATE_PORTRAITS, FOOD_AND_BEVERAGE, PRODUCT_PHOTOGRAPHY, VIDEO_PRODUCTION, DRONE_AERIAL, OTHER
