...
service_type must be one of: WEDDINGS, ENGAGEMENT_SESSION, QUINCEANERAS, MATERNITY, FAMILY, BIRTHDAY_PARTY, BAPTISMS, GRADUATION, CHILDRENS_SESSIONS, ARCHITECTURE, PORTRAITS, CORPORATE_PORTRAITS, FOOD_AND_BEVERAGE, PRODUCT_PHOTOGRAPHY, VIDEO_PRODUCTION, DRONE_AERIAL, OTHER
