...
export const SPOKE_PAGES: SpokePage[] = [
  ...
  // ── Proposal spokes (moved/added to weddings hub — draft, images provided) ──
  {
    ...
    priceFromUsd: '250',
    pricingDescEn: 'Standard package starts at $250 USD + 18% ITBIS. Custom packages available for multi-location proposals, private venues, or elaborate surprise ideas — contact us to quote your exact plan.',
    pricingDescEs: 'El paquete estándar comienza desde $250 USD + 18% ITBIS. Paquetes personalizados disponibles para propuestas en múltiples locaciones, lugares privados o ideas elaboradas — contáctanos para cotizar tu plan exacto.',
    whyUs: [
      { icon: '📡', titleEn: '400–600 mm Telephoto — She Never Sees Us', titleEs: '400–600 mm Teleobjetivo — Ella Nunca Nos Ve', bodyEn: 'We shoot with 400 to 600 mm telephoto lenses from a long distance. You can be 50 to 80 meters away from us and the images look like we were right there. Total invisibility guaranteed.', bodyEs: 'Disparamos con lentes de teleobjetivo de 400 a 600 mm desde larga distancia. Puedes estar a 50 u 80 metros de nosotros y las imágenes parecen tomadas de cerca. Invisibilidad total garantizada.' },
