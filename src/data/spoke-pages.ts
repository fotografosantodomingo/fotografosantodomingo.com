...
export const SPOKE_PAGES: SpokePage[] = [
  ...
  // ── Proposal spokes (moved/added to weddings hub — draft, images provided) ──
  {
    ...
    priceFromUsd: '250',
    pricingDescEn: 'Standard package starts at $250 USD + 18% ITBIS — full hidden coverage, preview gallery overnight. Custom packages available for distant beach locations requiring travel, multi-beach setups, second photographer, or printed album delivery to hotel. Contact us to quote your exact plan.',
    pricingDescEs: 'El paquete estándar comienza desde $250 USD + 18% ITBIS — cobertura oculta completa, galería de vista previa overnight. Paquetes personalizados disponibles para playas lejanas que requieren traslado, configuraciones en múltiples playas, segundo fotógrafo o entrega de álbum impreso en hotel. Contáctanos para cotizar tu plan.',
    whyUs: [
