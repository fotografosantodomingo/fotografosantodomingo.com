...
export const SPOKE_PAGES: SpokePage[] = [
  ...
  // ── Proposal spokes (moved/added to weddings hub — draft, images provided) ──
  {
    ...
    geoRegion: 'Various',
    titleEn: 'Proposal Photographer Dominican Republic — Beaches, Restaurants & City',
    titleEs: 'Fotógrafo de Propuesta República Dominicana — Playas, Restaurantes y Ciudad',
    descriptionEn: 'Surprise proposal photography across all of Dominican Republic — beaches, exclusive restaurants, rooftops, marinas, and private villas. We coordinate secretly with venue managers. Santo Domingo, Punta Cana, Samaná, Casa de Campo and more.',
    descriptionEs: 'Fotografía de propuesta sorpresa en toda República Dominicana — playas, restaurantes exclusivos, azoteas, marinas y villas privadas. Coordinamos en secreto con los managers del establecimiento. Santo Domingo, Punta Cana, Samaná, Casa de Campo y más.',
    keywordsEn: 'proposal photographer dominican republic, surprise proposal restaurant santo domingo, secret proposal photography punta cana restaurant, hidden photographer engagement DR, proposal photography city santo domingo',
    keywordsEs: 'fotografo propuesta matrimonio republica dominicana, propuesta sorpresa restaurante santo domingo, fotografia propuesta secreta restaurante punta cana, fotografo oculto compromiso RD, fotografia propuesta ciudad santo domingo',
    h1En: 'Surprise Proposal Photography Across Dominican Republic',
    h1Es: 'Fotografía de Propuesta Sorpresa en Toda República Dominicana',
    hookEn: 'Not just the beach. We photograph surprise proposals in exclusive restaurants, rooftops, marina docks, private villas, and everywhere in between — all across Dominican Republic. We coordinate secretly with venue managers so she never suspects a thing.',
    hookEs: 'No solo la playa. Fotografiamos propuestas sorpresa en restaurantes exclusivos, azoteas, muelles de marinas, villas privadas y en cualquier lugar de la isla — en toda República Dominicana. Coordinamos en secreto con los managers del establecimiento para que ella nunca sospeche nada.',
    ...
    whyUs: [
      { icon: '🏙️', titleEn: 'City, Restaurant & Indoor Proposals', titleEs: 'Propuestas en Ciudad, Restaurantes e Interiores', bodyEn: 'We have photographed proposals at Mesón de la Cava, La Briciola, and rooftop terraces in Santo Domingo, and at La Yola, Jellyfish, and marina restaurants in Punta Cana. Indoor proposals require different technique — we master it.', bodyEs: 'Hemos fotografiado propuestas en Mesón de la Cava, La Briciola y terrazas en azotea en Santo Domingo, y en La Yola, Jellyfish y restaurantes de marina en Punta Cana. Las propuestas en interiores requieren una técnica diferente — la dominamos.' },
    ...
    faq: [
      ...
      },
      {
        ...
        answerEn: 'In Santo Domingo we tend to recommend Mesón de la Cava — a unique underground cave restaurant that creates a completely unforgettable atmosphere — and La Briciola in the Zona Colonial, a romantic Italian restaurant inside a historic colonial building. Also Valetudo and Prime for rooftop proposals with city views. In Punta Cana, La Yola at Marina Cap Cana is perfect for marina proposals with the boats in the background. Jellyfish Beach Restaurant works well for a proposal at sunset on the sand. Kukua Beach Club and Playa Blanca are ideal for a more private beach-restaurant setting.',
        answerEs: 'En Santo Domingo tendemos a recomendar el Mesón de la Cava — un restaurante único en una cueva subterránea que crea una atmósfera completamente inolvidable — y La Briciola en la Zona Colonial, un romántico restaurante italiano dentro de un edificio colonial histórico. También Valetudo y Prime para propuestas en azotea con vistas a la ciudad. En Punta Cana, La Yola en Marina Cap Cana es perfecta para propuestas en la marina con los barcos de fondo. Jellyfish Beach Restaurant funciona muy bien para una propuesta al atardecer en la arena. Kukua Beach Club y Playa Blanca son ideales para un ambiente más privado de playa-restaurante.',
      },
      {
        ...
        answerEn: 'Yes — we cover all of Dominican Republic. Samaná, Las Terrenas, Casa de Campo in La Romana, Puerto Plata, Bayahíbe, and any private villa or boutique hotel across the island. Travel outside SDQ and Punta Cana is quoted per location.',
        answerEs: 'Sí — cubrimos toda República Dominicana. Samaná, Las Terrenas, Casa de Campo en La Romana, Puerto Plata, Bayahíbe y cualquier villa privada o hotel boutique en la isla. El traslado fuera de SDQ y Punta Cana se cotiza por locación.',
      },
      {
