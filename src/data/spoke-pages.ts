...
export const SPOKE_PAGES: SpokePage[] = [
...

  {
    ...
    descriptionEn: 'Hidden proposal photography in Punta Cana — we arrive 45 minutes early and stay invisible with a telephoto lens so she never knows we\'re there. All beaches and resorts, private gallery same night.',
    descriptionEs: 'Fotografía de propuesta oculta en Punta Cana — llegamos 45 minutos antes y permanecemos invisibles con teleobjetivo, para que ella nunca sepa que estuvimos ahí. Todas las playas y resorts, galería privada la misma noche.',
