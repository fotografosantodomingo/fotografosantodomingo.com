...
const OUTPUT_SCHEMA = `{
  ...
  "intro_es": "Un párrafo 70-90 palabras que abre con detalle visual y menciona ciudad + tipo de sesión. TEXTO PLANO, sin etiquetas <p> — el sitio ya lo envuelve en su propio <p>.",
  "intro_en": "One paragraph 70-90 words opening with a visual detail, mentioning city + session type. PLAIN TEXT, no <p> tags — the site already wraps it in its own <p>.",
  ...
  "location_section_es": "Un párrafo 70-90 palabras sobre la ubicación específica: luz, atmósfera, mejor horario. TEXTO PLANO, sin etiquetas <p>.",
  "location_section_en": "One paragraph 70-90 words about the specific location: light, atmosphere, best time. PLAIN TEXT, no <p> tags.",
  "faq_es": [
